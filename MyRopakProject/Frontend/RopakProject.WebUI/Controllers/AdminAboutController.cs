...
namespace RopakProject.WebUI.Controllers
{
    public class AdminAboutController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responnseMessage = await client.GetAsync("http://localhost:59253/api/About");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"http://localhost:59253/api/About/{id}");
        ...
        public async Task<IActionResult> UpdateAbout(UpdateAboutDto model)
        {
            ...
            var responseMessage = await client.PutAsync("http://localhost:59253/api/About/", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
